...
German version: [setup-filter-status-panel-decision.md](./setup-filter-status-panel-decision.md).
...
- Deploy options: [../vm-dashboard-install_EN.md](../vm-dashboard-install_EN.md)
- EVCC/Telegraf live ingest: [../evcc-telegraf-live-ingest_EN.md](../evcc-telegraf-live-ingest_EN.md)
- Troubleshooting for labels and blocklists: [../migration-troubleshooting_EN.md#business-labels-titles-and-blocklists](../migration-troubleshooting_EN.md#business-labels-titles-and-blocklists)