...
Note: The canonical end-user guide for EVCC/Telegraf to VictoriaMetrics is [../evcc-telegraf-live-ingest.md](../evcc-telegraf-live-ingest.md). This archived page remains as advanced background for multiple parallel backends.
