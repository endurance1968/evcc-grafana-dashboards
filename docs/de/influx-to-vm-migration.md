...
Englische Version: [influx-to-vm-migration.md](../en/influx-to-vm-migration.md).
...
Wenn VictoriaMetrics oder Grafana noch nicht installiert sind, starte mit [docs/de/README.md](../README.md).
