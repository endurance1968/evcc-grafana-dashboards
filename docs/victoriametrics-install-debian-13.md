...
Fuer EVCC und die Dashboards brauchst du normalerweise:
...
- EVCC oder Migrations-/Rollup-Skripte, die diese URL lesen oder beschreiben

Die InfluxDB-zu-VictoriaMetrics-Migration ist separat beschrieben:
