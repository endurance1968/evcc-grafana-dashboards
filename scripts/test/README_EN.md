...
Purpose: start disposable Grafana and VictoriaMetrics, import fixture data, and render the critical dashboard panels in a browser.

Default fixture with AUX/EXT:
