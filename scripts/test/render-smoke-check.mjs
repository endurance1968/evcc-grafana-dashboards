...
const criticalPanelsByFile = {
  "VM_EVCC_All-time.json": [
    ...
    {
      "id": 55,
      "title": "Average yearly specific yield"
    },
    {
      "id": 24,
      "title": "Metric gauges"
  ...
  "VM_EVCC_Year.json": [
    ...
    {
      "id": 54,
      "title": "Dynamic electricity price"
    },
    {
      "id": 37,
      "title": "Battery summary"
    ...
    {
      "id": 72,
      "title": "Heat pump total"
    },
    {
      "id": 74,
      "title": "Charging stations total"
    },
    {
      "id": 59,
      "title": "Vehicles"
  ...
  "VM_EVCC_Month.json": [
    ...
    {
      "id": 26,
      "title": "Dynamic electricity price (ct/kWh)"
    },
    {
      "id": 16,
      "title": "Battery summary"
