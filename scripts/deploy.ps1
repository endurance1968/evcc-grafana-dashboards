...
function Get-DashboardOverrides() {
  ...
  return @{
    ...
    consumerBlocklist = $settings.DASHBOARD_FILTER_CONSUMER_BLOCKLIST
    consumerLegacyExtRegex = $settings.DASHBOARD_CONSUMER_LEGACY_EXT_REGEX
