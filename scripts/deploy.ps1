...
function Get-DashboardOverrides() {
  return @{
    ...
    vVerbrauch = $settings.DASHBOARD_ICE_CONSUMPTION_L_PER_100KM
    spritKosten = $settings.DASHBOARD_FUEL_PRICE_PER_L
    ...
    speicherkapazitaet = $settings.DASHBOARD_BATTERY_CAPACITY_WH
